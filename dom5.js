...
function copyText(e1){
    ...
    var addUserList = document.getElementById("userList");
    var addUserDetails = document.createElement("li");
    addUserDetails.className="list-group-item";
    var textItem = document.createTextNode(`${val1} : ${val2}`);
    addUserDetails.appendChild(textItem);
    addUserList.appendChild(addUserDetails);
    ...
    data.push(val);
    localStorage.setItem(val1,JSON.stringify(data));
    }
    saveData(val1,val2);
